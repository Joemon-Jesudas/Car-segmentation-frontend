...
if selected == "HOW IT WORK":
    run_app("howit.py")

if selected == "ABOUT US":
    st.markdown(
        f'<meta http-equiv="refresh" content="0;URL=\'https://www.allianz.com/en/about-us.html\'" />',
        unsafe_allow_html=True,
    )

if selected == "CONTACT":
    st.markdown(
        f'<meta http-equiv="refresh" content="0;URL=\'https://www.allianz.com/en/about-us/who-we-are/worldwide.html \'" />',
        unsafe_allow_html=True,
    )
